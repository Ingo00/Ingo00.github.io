...
var discardThreshold = 1.8; // Stjórnar hversu gegnsær tepotturinn er
var hue = 0; // Hue í HSV fyrir dreiflit
...
window.onload = function init() {
    ...
    var discardThresholdLoc = gl.getUniformLocation(program, "discardThreshold");
...
function updateDiffuseColor(program) {
